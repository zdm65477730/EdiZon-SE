...
void ListSelector::onTouch(const HidTouchState &touch) {
...
void ListSelector::onGesture(const HidTouchState &startPosition, const HidTouchState &endPosition, bool finish) {
